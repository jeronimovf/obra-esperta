...
import br.com.obraesperta.maven.si.controllers.CampanhaFacade;
...
public class CampanhaConverter implements Converter {
    ...
    @Inject
    private CampanhaFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Campanha) {
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Campanha.class.getName()});
            return null;
        }
    }
